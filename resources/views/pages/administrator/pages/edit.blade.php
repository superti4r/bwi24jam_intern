    ...
    <div class="page">
        <div class="page__header">
            <div class="page__headline">
                <h1 class="page__title">Ubah Halaman</h1>
                <p class="page__description">Perbarui informasi halaman custom.</p>
            </div>
        ...
        <div class="card w-full">
            <div class="card__header card__header--alt">
                <h2 class="card__title m-0">Form Ubah Halaman</h2>
            </div>

            <form method="POST" action="{{ route('administrator.pages.update', $page) }}" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="card__body">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="field">
                            ...
                            <div id="editor" data-quill>{!! old('content', $page->content) !!}</div>
