    ...
    <div class="page">
        <div class="page__header">
            <div class="page__headline">
                <h1 class="page__title">Tambah User</h1>
                <p class="page__description">Buat akun pengguna baru.</p>
            </div>
        ...
        <div class="card w-full">
            <div class="card__header card__header--alt">
                <h2 class="card__title m-0">Form Tambah User</h2>
            </div>

            <form method="POST" action="{{ route('administrator.users.store') }}" class="space-y-4">
                @csrf
                ...
                <div class="card__body">
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="field">
                            ...
                            <input id="password" type="password" name="password" class="input" placeholder="Buat password"
                                required>
                            @error('password')
                                <p class="field__error">{{ $message }}</p>
                            @enderror
